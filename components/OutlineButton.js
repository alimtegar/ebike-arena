const OutlineButton = ({ children, onClick, width, height }) => {
    const initClassName = 'flex justify-center items-center text-white border-2 border-white rounded-lg hover:bg-white hover:text-gray-900 focus:outline-none pointer-events-auto';
