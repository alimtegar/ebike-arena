export const InfoIcon = ({ width, height, color }) => {
    ...
    return (
        <svg className={widthClassName + heightClassName + colorClassName} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export const ShoppingCartIcon = ({ width, height, color }) => {
    ...
    return (
        <svg className={widthClassName + heightClassName + colorClassName} viewBox="0 0 20 20" fill="currentColor">
...
export const SearchIcon = ({ width, height, color }) => {
    ...
    return (
        <svg className={widthClassName + heightClassName + colorClassName} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M8 4a4 4 0 100 8 4 4 0 000-8zM2 8a6 6 0 1110.89 3.476l4.817 4.817a1 1 0 01-1.414 1.414l-4.816-4.816A6 6 0 012 8z" clipRule="evenodd" />
        </svg>
    );
};

export const ChevronLeftIcon = ({ width, height, color }) => {
    const widthClassName = width ? 'w-' + width : '';
    const heightClassName = height ? ' h-' + height : '';
    const colorClassName = color ? ' text-' + color : '';
...
export const ChevronDownIcon = ({ width, height, color }) => {
    const widthClassName = width ? 'w-' + width : '';
    const heightClassName = height ? ' h-' + height : '';
    const colorClassName = color ? ' text-' + color : '';
...
export const TwitterIcon = ({ width, height, color }) => {
    ...
    return (
        <svg className={widthClassName + heightClassName + colorClassName} role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
...
export const InstagramIcon = ({ width, height, color }) => {
    ...
    return (
        <svg className={widthClassName + heightClassName + colorClassName} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
